 ...
 * @author swoeste
 */
public class AbstractSkillActivationAttributeReceptor extends AbstractAttributeReceptor {

    private final CreatureAttribute attribute;

    public AbstractSkillActivationAttributeReceptor(final Creature creature, final CreatureAttribute attribute) {
        super(creature);
    ...
    protected void storeValue(final Creature creature, final double value) {
        final int newValue = value >= 0.0 ? 1 : -1;
        creature.setAttributeValue(this.attribute, newValue);
    }
