...
public class MoveDistanceReceptor extends AbstractAttributeReceptor {
    ...
    protected void storeValue(final Creature creature, final double value) {
        final int maxDistance = creature.getAttributeValue(CreatureAttribute.MAX_MOVE_DISTANCE);
        final int consideredDistance = (int) Math.round(maxDistance * value);
        creature.setAttributeValue(CreatureAttribute.CONSIDERED_MOVE_DISTANCE, consideredDistance);
    }
